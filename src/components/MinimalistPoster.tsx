...
const MinimalistPoster = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {[1, 2].map((index) => (
        <Card key={index} className="relative overflow-hidden aspect-[2/3] p-8 bg-gradient-to-br from-blue-50 to-indigo-100 group hover:shadow-xl transition-all duration-500">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <p className="text-sm text-gray-600">Launching {content.launched}</p>
          </div>
        </Card>
      ))}
    </div>
